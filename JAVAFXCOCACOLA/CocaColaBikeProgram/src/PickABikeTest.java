...
public class PickABikeTest {
	...
	public static void  ChooseBikes () {
	 ...
	 String [] myLoc = {"Popes quay","College Of Commerce","UCC", "Cork School of Music", "Kent East"};
		...
		b1.setOnAction(e -> DoneScreen.show());
		...
		b1.setOnAction(e -> DoneScreen.show());
		bloc.setOnAction(e -> System.out.println("User is going to drop the bike at: " + bloc.getValue()));
		...
		Label WhereLabel = new Label("Where you want to drop the bike: ");
		
//		vbox.setPadding(new Insets(30, 30, 30, 30));
//		vbox.getChildren().addAll(pq, ccom, ucc, Num1, bloc, b1, loc);
//
...
//		window.show();
		...
		Label PickLabel = new Label("How many bikes do you want to rent?");
		
		
		vbox.setPadding(new Insets(30, 30, 30, 30));
		vbox.getChildren().addAll(PickLabel, Num1, ccom, pq, ucc, csm, ke,  WhereLabel, bloc, b1);
